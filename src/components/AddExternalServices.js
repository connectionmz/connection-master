...
import { db } from '../fb'; // Import Firebase config
...
const AddExternalServices = () => {
  ...
  const [newCategory, setNewCategory] = useState(''); // Estado para o formulário de nova categoria
  const [successMessage, setSuccessMessage] = useState('');
  const [errorMessage, setErrorMessage] = useState('');

  // Função para buscar categorias do Firebase
  useEffect(() => {
